...
public class Mainframe {
	...
	protected void createContents() {
		...
		final Button btnCognitiveToTCP = new Button(grpSettings, SWT.CHECK);
		btnCognitiveToTCP.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent arg0) {
				boolean state = btnCognitiveToTCP.getSelection();
				BackendControl.getInstance().setCognitiveToTCP(state);
			}
		});
		btnCognitiveToTCP.setText("Cognitive TO TCP");
/*
